...
const ServiceModal = ({ closeModal }) => {
  ...
  console.log("Hello Fuad Loves Maisha");
  return (
    <div>
      <style jsx>
        {`
      ...
      <div className="z-[1000] modal modal-bottom sm:modal-middle cursor-pointer bgGlass">
        <div
          className="modal-box max-h-[50%] rounded-none bg-blue-500 p-0"
          style={{
