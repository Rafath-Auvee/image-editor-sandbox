      ...
      >
        ...
        >
          {selectedTextIndex === null ? (
            ...
            >
              <div
                className="flex flex-row bg-white sticky bottom-0 overflow-x-auto content-start justify-start h-20"
                // style={{ position: "absolute", zIndex: 999 }}
              >
                <button
                  className="min-w-[16.7%]"
                ...
                <button className="min-w-[16.7%]">
                  <div>
                    ...
                    />
                    <div
                      className="modal modal-bottom  z-[1000] "
                      role="dialog"
                    >
                ...
                <button className="min-w-[16.7%]">
                  <div>
                    <div>
                      ...
                      >
                        <Alignment />
                        <span className="btm-nav-label font-thin">
                          Alignment
                        </span>
                      </label>
                      <input
